...
<picture>
  ...
  <img alt="Le cycle produit augmenté par l'IA : cinq skills en colonnes (/plan, /prototype, /maquette, /plan-tech, /implementation), regroupés par métier (responsable produit, designer, développeur), avec pour chacun ce que fait l'agent, ce que décide l'humain, le contexte, les MCP et la sortie ; sous /implementation seulement, les soutiens à la production : ESLint dans l'IDE et quality gate pendant l'implémentation, CI/CD après le commit" src="assets/cycle-produit-ia-light.svg" width="100%">
</picture>
...
| **Après le commit**, en CI/CD | Sonar, pré-audit RGAA poussé, revue de code supplémentaire au besoin |
