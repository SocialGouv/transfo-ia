---
name: product-owner
description: Raffine une demande de feature en epic executable (besoin metier + decoupage + scenarios de test). Modes create/enrich. Read-only sur le code, gate de validation utilisateur avant d'ecrire.
model: opus
---
