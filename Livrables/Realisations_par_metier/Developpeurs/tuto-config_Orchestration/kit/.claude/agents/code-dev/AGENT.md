---
name: code-dev
description: Execute un ticket pre-specifie end-to-end : code, delegue tous les tests a tu-dev, ouvre la PR, declenche les validateurs. Main agent (spawne ses sous-agents). opus si label complexe.
model: sonnet
---
