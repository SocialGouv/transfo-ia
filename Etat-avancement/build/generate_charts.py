...
BENCH_NOTES = [
    ...
    "SWE-bench Verified en baseline : saturé, harness hétérogènes",
    "Sans marque = officiel (leaderboard ou annonce vérifiée) · ᵛ auto-rapporté par l'éditeur · "
    "* mesure indépendante (vals.ai, Artificial Analysis) · llm-stats = agrégat, non re-mesuré",
